...
export const createOrder = (order) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`https://deployanimeecom-lt0t.onrender.com/api/orders/add/`, order, config);
...
export const getOrderDetails = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`https://deployanimeecom-lt0t.onrender.com/api/orders/${id}/`, config);
  ...
  try {
   ...
   // pulls out the credentials of currently logged in user
    ...
    const { data } = await axios.put(
      `https://deployanimeecom-lt0t.onrender.com/api/orders/${id}/pay/`,
      paymentResult,
      config
    );
...
export const listMyOrders = () => async (dispatch, getState) => {
  try {
    ...
    /* API method to get the order details */
    const { data } = await axios.get(`https://deployanimeecom-lt0t.onrender.com/api/orders/myorders/`, config);
...
export const listOrders = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`https://deployanimeecom-lt0t.onrender.com/api/orders/`, config);
...
export const deliverOrder = (order) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `https://deployanimeecom-lt0t.onrender.com/api/orders/${order._id}/deliver/`,
      {},
      config
    );
