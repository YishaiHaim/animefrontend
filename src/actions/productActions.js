...
export const listProducts =
  ...
  async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`https://deployanimeeecom.onrender.com/api/products${keyword}`);
...
export const listTopProducts = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://deployanimeeecom.onrender.com/api/products/top/`);
