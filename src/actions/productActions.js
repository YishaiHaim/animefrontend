...
export const listProducts =
  ...
  async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`https://deployanimeecom-lt0t.onrender.com/api/products${keyword}`);
...
export const deleteProduct = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.delete(`https://deployanimeecom-lt0t.onrender.com/api/products/delete/${id}/`, config);
...
export const createProduct = () => async (dispatch, getState) => {
  ...
  // pulls out the credentials of currently logged in user
    ...
    const { data } = await axios.post(`https://deployanimeecom-lt0t.onrender.com/api/products/create/`, {}, config);
  ...
  try {
   ...
   // pulls out the credentials of currently logged in user
    ...
    const { data } = await axios.put(
      `https://deployanimeecom-lt0t.onrender.com/api/products/update/${product._id}/`,
      product,
      config
    );
...
// pulls out the credentials of currently logged in user
      ...
      const { data } = await axios.post(
        `https://deployanimeecom-lt0t.onrender.com/api/products/${productId}/reviews/`,
        review,
        config
      );
...
export const listTopProducts = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://deployanimeecom-lt0t.onrender.com/api/products/top/`);
